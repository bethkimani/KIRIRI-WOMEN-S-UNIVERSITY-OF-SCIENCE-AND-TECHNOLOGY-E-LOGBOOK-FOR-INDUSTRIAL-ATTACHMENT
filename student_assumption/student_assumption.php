<?php
  ...
  $regions = array("Nairobi Region","Central Region","Eastern Region","Western Region",
  "Rift Valley Region","Northern Region","Nyanza Region","North Eastern Region","Coast Region","North Western Region");

  $programmes = array("-","Accountancy","Applied Mathematics","Community Development","Procurement","Computer Science","Information Technology Communication",
  "Banking & Financing","Hospitality","Business Information Technology","Marketing","Purchasing & Supply","Information Tecnology");
...
<div id="top-navigation">
  <div id="header_logo"><img src="../img/kwust.png" class="img-responsive" alt="logo" style="float:left;width:50px; height:50px;position:relative;left:20px"/></div>
