...
<body>
  ...
  <div class="login-wrap">
	<div class="login-html">
		...
		<div id="text_holder">
			<h2><span style="color:rgba(255, 152, 0, 0.91);text-align:center;font-family:sans"> ATTACHMENT E-LOGBOOK<br><br>MANAGEMENT SYSTEM</span></h2>
		</div>
      ...
      <form method="post" action="">
        ...
        <div class="group">
          <label for="index_number" class="label">Adm No</label>
