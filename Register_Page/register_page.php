      ...
      <div class="col-lg-6">
        <div class = "panel">
           <div class = "panel-body pbody pbody_vira">
              ...
              Attachment at Kiriri Univeristy,<br><em style="font-weight:bold;color:#2B3775"> Please Click On The Button Below </em></span>
          <br><br>
      ...
      <div class="col-lg-6">
        <div class = "panel">
           <div class = "panel-body pbody pbody_industrial">
              <span>In case you are interning with a company or institution other than Kiriri University,<br><em style="font-weight:bold;color:#2B3775"> Please Click On The Button Below </em></span>
          <br><br>
