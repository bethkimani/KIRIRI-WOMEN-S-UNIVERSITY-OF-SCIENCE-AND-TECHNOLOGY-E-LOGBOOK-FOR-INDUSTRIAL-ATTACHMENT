...
$submit_status = "disabled";
  ...
  $programmes = array("-","Accountancy","Applied Mathematics","Community Development","Procument","Computer Science","Information Technology Communication",
  "Banking & Financing","Hospitality","Business Information Technoloy","Marketing","Purchasing & Supply","Information Technology");

  $faculties = array("-","KBA","BBIT","KED","KMA","KCS");

  $sessions = array("-","Morning","Evening","Weekend");

  $levels = array("-","2nd Year","3rd Year","4th Year");
  ...
  if(isset($_POST["btn-check-receipt"])){
    ...
    if($get_receipt_details == 1){
      ...
      $other_name_status="enabled";
      $index_status="enabled";
      $first_name_holder = "";
      $last_name_holder = "";
      $index_number_holder = "";
      $submit_status = "enabled";
    }
  }
